...
namespace Survivors.Location
{
    public class WorldServicesInstaller : MonoBehaviour
    {
        ...
        [SerializeField] private LevelWavesSpawner _levelWavesSpawner;
        ...
        public void Install(DiContainer container)
        {
            ...
            container.BindInterfacesAndSelfTo<LevelWavesSpawner>().FromInstance(_levelWavesSpawner).AsSingle();
