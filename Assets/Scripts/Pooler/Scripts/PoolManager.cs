...
public class PoolManager : Singleton<PoolManager>
{
	...
	public bool isWarmPool(GameObject prefab)
	{
	...
	{
		var go = AppContext.Container.InstantiatePrefab(prefab) as GameObject;
		go.SetActive(false);
	...
	public static bool IsWarmPool(GameObject prefab)
	{
		return Instance.isWarmPool(prefab);
	}
